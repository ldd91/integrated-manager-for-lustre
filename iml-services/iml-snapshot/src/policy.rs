...
fn get_obsolete(policy: &SnapshotPolicy, snapshots: Vec<(DateTime<Utc>, String)>) -> Vec<String> {
    let immune_count = snapshots.iter().filter(|x| !x.1.starts_with("__")).count();
    let quota = policy.keep - (policy.daily + policy.weekly + policy.monthly + immune_count as i32);

    let mut tail: Vec<_> = snapshots
        .iter()
        .skip(std::cmp::max(0, quota) as usize)
        .map(|x| x.0)
        .collect();

    tracing::debug!("all snapshots of {}: {:?}", policy.filesystem, tail);
    ...
    if excess > 0 {
        ...
        let mut more = keep
            ...
            .collect();
        tracing::debug!(
            "extra snapshots of {} to delete to keep number under {}: {:?}",
            policy.filesystem,
            policy.keep,
            more
        );
...
mod tests {
    ...
    #[test]
    fn test_get_obsolete_automatic() {
        ...
        let snapshots = snapshots(vec![
            ...
            ("2020-11-12T05:11:00Z", "__18"),
            ("2020-11-06T23:11:23Z", "__19"),
            ("2020-11-05T13:55:00Z", "__20"),
            ("2020-11-01T13:11:31Z", "__21"),
            ("2020-10-31T10:55:32Z", "__22"),
            ("2020-10-31T00:55:00Z", "__23"),
            ("2020-10-23T00:55:00Z", "__24"),
            ("2020-10-01T00:01:00Z", "__25"),
            ("2020-09-21T00:00:33Z", "__26"),
        ]);
        ...
        let expected_obsolete: Vec<String> = vec![
            "__03", "__05", "__06", "__08", "__09", "__11", "__14", "__15", "__16", "__18", "__20",
            "__23", "__24", "__25",
        ]
        .into_iter()
        .map(String::from)
    ...
    fn test_get_obsolete_mixed() {
        ...
        let expected_obsolete: Vec<String> = vec![
            "__03", "__05", "__06", "__08", "__11", "__14", "__15", "__16", "__18", "__20", "__21",
            "__22", "__23", "__24", "__25",
        ]
        .into_iter()
        .map(String::from)
    ...
    fn test_get_obsolete_max() {
        ...
        let expected_obsolete: Vec<String> = vec![
            "__03", "__04", "__05", "__06", "__07", "__08", "__10", "__11", "__12", "__13", "__14",
            "__15", "__16", "__18", "__19", "__20", "__21", "__22", "__23", "__24", "__25",
        ]
        .into_iter()
        .map(String::from)
        .collect();
